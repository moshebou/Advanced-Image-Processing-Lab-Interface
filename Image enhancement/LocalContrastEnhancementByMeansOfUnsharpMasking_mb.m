...
function LocalContrastEnhancementByMeansOfUnsharpMasking = LocalContrastEnhancementByMeansOfUnsharpMasking_mb(handles)
	...
	LocalContrastEnhancementByMeansOfUnsharpMasking = DeployAxes( handles.figure1, ...
	[axes_hor, ...
	axes_ver], ...
	bottom, ...
	left, ...
	...
	LocalContrastEnhancementByMeansOfUnsharpMasking.im = HandleFileList('load' , HandleFileList('get' , handles.image_index)); 

	%init params
	LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzX = 5;%3;
	LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzY = 5;%3;
    WindowSize=LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzX*LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzY;
	LocalContrastEnhancementByMeansOfUnsharpMasking.evpos = 10;%5;
	LocalContrastEnhancementByMeansOfUnsharpMasking.evneg = 10;%5;
	LocalContrastEnhancementByMeansOfUnsharpMasking.erpos = fix(WindowSize/2);%5;
	LocalContrastEnhancementByMeansOfUnsharpMasking.erneg = fix(WindowSize/2);%5;
    LocalContrastEnhancementByMeansOfUnsharpMasking.EdgeEnType = 'Rank filters';
	...
	interface_params =  SetSliderParams('Set EVplus for Mean/Medn-EV filters', 64, 0, ....
        LocalContrastEnhancementByMeansOfUnsharpMasking.evpos, 1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'evpos',@update_sliders), interface_params, k);

	k=k+1;
	interface_params =  SetSliderParams('Set EVminus for Mean/Medn-EV filters', 64, 0, ....
        LocalContrastEnhancementByMeansOfUnsharpMasking.evneg, 1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'evneg',@update_sliders), interface_params, k);

	k=k+1;
	interface_params =  SetSliderParams('Set ERplus', fix(WindowSize/2), 0,.....
        LocalContrastEnhancementByMeansOfUnsharpMasking.erpos, 1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'erpos',@update_sliders), interface_params, k);
    
	k=k+1;
	interface_params =  SetSliderParams('Set ERminus', fix(WindowSize/2),0,.....
        LocalContrastEnhancementByMeansOfUnsharpMasking.erneg, 1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'erneg',@update_sliders), interface_params, k);

	k=k+1;
	interface_params =  SetSliderParams('Set filter window width', 51, 1,....
        LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzX, 2, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'WdSzX',@update_sliders), interface_params, k);

	k=k+1;
	interface_params =  SetSliderParams('Set filter window height', 51, 1,.....
        LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzY, 2, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'WdSzY',@update_sliders), interface_params, k);
    ...
    interface_params(k).value = find(strcmpi(interface_params(k).selection, .....
        LocalContrastEnhancementByMeansOfUnsharpMasking.EdgeEnType));
    


	LocalContrastEnhancementByMeansOfUnsharpMasking.buttongroup_handle = SetInteractiveInterface(handles, interface_params); 
		             

    imshow(LocalContrastEnhancementByMeansOfUnsharpMasking.im, [0 255], 'parent', LocalContrastEnhancementByMeansOfUnsharpMasking.axes_1);
    DisplayAxesTitle( LocalContrastEnhancementByMeansOfUnsharpMasking.axes_1, 'Test image','TM',10);
% 	process_image (LocalContrastEnhancementByMeansOfUnsharpMasking.im, LocalContrastEnhancementByMeansOfUnsharpMasking.evpos, LocalContrastEnhancementByMeansOfUnsharpMasking.evneg, LocalContrastEnhancementByMeansOfUnsharpMasking.erpos, LocalContrastEnhancementByMeansOfUnsharpMasking.erneg, ...
% 	LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzX, LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzY, ...
% 	LocalContrastEnhancementByMeansOfUnsharpMasking.axes_1, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_2, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_3, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_4, ...
% 	LocalContrastEnhancementByMeansOfUnsharpMasking.axes_5, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_6);
...
function run_process_image(handles)
    ...
    LocalContrastEnhancementByMeansOfUnsharpMasking = handles.(handles.current_experiment_name);
    process_image (LocalContrastEnhancementByMeansOfUnsharpMasking.im, LocalContrastEnhancementByMeansOfUnsharpMasking.EdgeEnType, LocalContrastEnhancementByMeansOfUnsharpMasking.evpos, LocalContrastEnhancementByMeansOfUnsharpMasking.evneg, LocalContrastEnhancementByMeansOfUnsharpMasking.erpos, LocalContrastEnhancementByMeansOfUnsharpMasking.erneg, ...
        LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzX, LocalContrastEnhancementByMeansOfUnsharpMasking.WdSzY, ...
        LocalContrastEnhancementByMeansOfUnsharpMasking.axes_1, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_2, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_3, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_4, ...
        LocalContrastEnhancementByMeansOfUnsharpMasking.axes_5, LocalContrastEnhancementByMeansOfUnsharpMasking.axes_6);
end
