...
%%
function ImageLocalStandardization = ImageLocalStandardization_mb( handles )
    %ImageLocalStandardization_mb Summary of this function goes here
    ...
    ImageLocalStandardization = DeployAxes( handles.figure1, ...
            [axes_hor, ...
            axes_ver], ...
            bottom, ...
            left, ...
...
%
    ...
    ImageLocalStandardization.im_1 = HandleFileList('load' , HandleFileList('get' , handles.image_index));
    ImageLocalStandardization.SzX = 5;
    ImageLocalStandardization.SzY = 5;
    ImageLocalStandardization.STD = 100;
    ...
    k=k+1;
    interface_params =  SetSliderParams('Set Local StDeviation', 255, 1, ImageLocalStandardization.STD, 1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'STD',@update_sliders), interface_params, k);

    k=k+1;
    interface_params =  SetSliderParams('Set Window Width', 25, 1, ImageLocalStandardization.SzX, 2, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'SzX',@update_sliders), interface_params, k);

    k=k+1;
    interface_params =  SetSliderParams('Set Window Height', 25, 1, ImageLocalStandardization.SzY, 2, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'SzY',@update_sliders), interface_params, k);  
    %
    ...
    ImageLocalStandardization.buttongroup_handle = SetInteractiveInterface(handles, interface_params); 
                 


    imshow(ImageLocalStandardization.im_1, [0 255], 'parent', ImageLocalStandardization.axes_1);
    DisplayAxesTitle( ImageLocalStandardization.axes_1, 'Test image','TM',10);
    h1 = histc(ImageLocalStandardization.im_1(:), [0:255]);
    plot( h1, 'parent', ImageLocalStandardization.axes_4, 'linewidth', 2);
    title( ImageLocalStandardization.axes_4, ['Test image histogram'], 'fontweight', 'bold'); 
    grid(ImageLocalStandardization.axes_4, 'on');
    axis(ImageLocalStandardization.axes_4, 'tight');
%     process_image( ImageLocalStandardization.im_1, ...
%     ImageLocalStandardization.SzX, ...
%     ImageLocalStandardization.SzY, ...
%     ImageLocalStandardization.STD, ...
%     ImageLocalStandardization.axes_1, ...
%     ImageLocalStandardization.axes_2, ...
%     ImageLocalStandardization.axes_3, ...
%     ImageLocalStandardization.axes_4, ...
%     ImageLocalStandardization.axes_5, ...
%     ImageLocalStandardization.axes_6);
...
function run_process_image(handles)
    if ( ~isstruct(handles))
        ...
        ImageLocalStandardization = handles.(handles.current_experiment_name);
        process_image( ImageLocalStandardization.im_1, ...
            ImageLocalStandardization.SzX, ...
            ImageLocalStandardization.SzY, ...
            ImageLocalStandardization.STD, ...
