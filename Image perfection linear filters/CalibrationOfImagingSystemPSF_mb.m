...
function CalibrationOfImagingSystemPSF = CalibrationOfImagingSystemPSF_mb( handles )
    ...
    CalibrationOfImagingSystemPSF.g = 3;
    CalibrationOfImagingSystemPSF.blur_var = 5;
    CalibrationOfImagingSystemPSF.blur_sz = 3;
    CalibrationOfImagingSystemPSF.noise_std = 1;
    %
    k=1;
    ...
    0.1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'g',@update_sliders), interface_params, k); 
    ...
    k=k+1;
    interface_params =  SetSliderParams('Set STDev of additive noise', 5, 0, CalibrationOfImagingSystemPSF.noise_std, 0.1, @(a,b)SetParam(a,b,k,handles.current_experiment_name, 'noise_std',@update_sliders), interface_params, k);
...
DisplayAxesTitle( axes_2, {['Blurred input image with noise'], [ 'PSNR = ' num2str(255/noise_std, '%0.1f') ]},   'TM'); 
